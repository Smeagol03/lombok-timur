            ...
            <div class="absolute bottom-0 left-0 right-0 p-6 md:p-12">
                <div class="max-w-4xl mx-auto">
                    ...
                    <nav class="flex items-center text-sm text-gray-300 mb-4">
                        ...
                        <a href="{{ url('/berita') }}" class="hover:text-white">Berita</a>
                        <svg class="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                        </svg>
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-4">
                        <span class="px-3 py-1 text-sm font-medium rounded-full" style="background-color: {{ $berita->kategori->warna ?? '#C8960C' }}30; color: {{ $berita->kategori->warna ?? '#C8960C' }}">
                    ...
                    {{-- Title --}}
                    <h1 class="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight">
                        {{ $berita->judul }}
                    </h1>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-card shadow-sm p-6 md:p-10">
                    ...
                    <div class="flex items-center gap-4 pb-6 mb-6 border-b border-gray-100">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">{{ $berita->penulis->name ?? 'Admin' }}</p>
                    ...
                    <div class="mt-10 pt-6 border-t border-gray-100">
                        <p class="text-sm font-medium text-gray-700 mb-3">Bagikan artikel:</p>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <article class="bg-white rounded-card shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                        <a href="{{ url('/berita/'.$related->slug) }}">
